...
class SMPLXHead(nn.Module):
    def __init__(
        ...
        self.predict_body = True
        self.apply_hand_network_on_body = True
        self.apply_hand_network_on_hands = True
        self.predict_hands = True
        self.apply_head_network_on_body = True
        self.apply_head_network_on_head = True
        self.predict_head = True
        self.detach_mean = False
        self.condition_hand_on_body = True
        self.condition_hand_wrist_pose = True
        self.condition_hand_finger_pose = True
        self.condition_hand_shape = False

        self.hand_add_shape_noise = False
        self.hand_shape_std = 1.0
        self.hand_shape_prob = 0.0
        self.add_hand_pose_noise = False
        self.hand_pose_std = 1.0
        self.num_hand_components = 3
        self.hand_noise_prob = 0.0

        self.hand_randomize_global_orient = False
        self.hand_global_rot_max = 45.0
        self.hand_global_rot_min = -45.0
        self.hand_global_rot_noise_prob = 0.0

        self.condition_head_on_body = True
        self.condition_head_neck_pose = False
        self.condition_head_jaw_pose = True
        self.condition_head_shape = False
        self.condition_head_expression = True

        self.head_add_shape_noise = False
        self.head_shape_std = 1.0
        self.head_shape_prob = 0.0

        self.add_expression_noise = False
        self.expression_std = 1.0
        self.expression_prob = 0.0

        self.add_jaw_pose_noise = False
        self.jaw_pose_min = 0.0
        self.jaw_pose_max = 45.0
        self.jaw_noise_prob = 0.0

        self.head_randomize_global_orient = True
        self.head_global_rot_min = -45.0
        self.head_global_rot_max = 45.0
        self.head_global_rot_noise_prob = 0.0
